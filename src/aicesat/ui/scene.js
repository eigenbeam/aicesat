...
const MISSION_COLORS = {GLAS: [255, 205, 50], ICESSN: [0, 190, 130], ATL06: [175, 110, 255], ICESAT2: [86, 180, 233]};
...
function candidateLayers() {
  ...
  if (c && bounds) {
    ...
    const stickH = Math.max(span * 0.32, (bounds.maxz - bounds.minz) * Z_EXAG * 0.9);   // stays tall at any vertical exag
    ...
    layers.push(new PathLayer({id: 'cand-stick', data: [[base, top]], getPath: d => d, getColor: MARK, getWidth: 3,
      widthUnits: 'pixels', updateTriggers: {getPath: Z_EXAG}}));
